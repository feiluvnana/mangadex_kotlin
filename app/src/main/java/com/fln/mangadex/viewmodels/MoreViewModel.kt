...
@Inject constructor(private val datastoreService: DatastoreRepository) :
  ...
  init {
    viewModelScope.launch {
      combine(datastoreService.get(DatastoreRepository.DOWNLOADED_ONLY),
        ...
        datastoreService.get(DatastoreRepository.LOCK_WHEN_IDLE)) { downloadedOnly, incognitoMode, secureScreen, requireUnlock, lockWhenIdle ->
  ...
  suspend fun toggleRequireUnlock() {
    datastoreService.set(DatastoreRepository.REQUIRE_UNLOCK,
